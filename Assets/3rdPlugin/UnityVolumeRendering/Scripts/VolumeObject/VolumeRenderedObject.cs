...
namespace UnityVolumeRendering
{
    ...
    public class VolumeRenderedObject : MonoBehaviour
    {
        ...
        public void SetTransferFunction2D(TransferFunction2D tf2d)
        {
            this.transferFunction2D = tf2d;
            UpdateMaterialProperties();
        }

        public async Task SetTransferFunction2DAsync(TransferFunction2D tf2d, IProgressHandler progressHandler = null)
        {
            if (meshRenderer.sharedMaterial == null)
            {
                meshRenderer.sharedMaterial = new Material(Shader.Find("VolumeRendering/DirectVolumeRenderingShader"));
            ...
            {
                transferFunction2D = new TransferFunction2D();
            }
