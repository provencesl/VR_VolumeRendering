...
namespace UnityVolumeRendering
{
    ...
    public class VolumeRenderedObjectCustomInspector : Editor, IProgressView
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            float newMin = EditorGUILayout.FloatField(visibilityWindow.x, GUILayout.Width(70));
            GUILayout.FlexibleSpace();
            EditorGUILayout.LabelField("Max:", GUILayout.Width(35));
            float newMax = EditorGUILayout.FloatField(visibilityWindow.y, GUILayout.Width(70));
